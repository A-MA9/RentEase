        ...
        child: Column(
          children: [
            GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(
                    isNotificationExpanded ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                    color: Colors.black,
                  ),
                ],
              ),
            ...
            if (isNotificationExpanded) ...[
              SizedBox(height: 10),
              _buildNotificationOption("Recommendations via mail", emailNotifications, (value) {
                setState(() {
                  emailNotifications = value;
                });
              }),
              _buildNotificationOption("Notifications of chat", chatNotifications, (value) {
                setState(() {
